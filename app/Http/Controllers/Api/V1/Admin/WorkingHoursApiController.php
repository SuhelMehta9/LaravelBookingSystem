...
class WorkingHoursApiController extends Controller
{
    public function index()
    {
        abort_if(Gate::denies('working_hour_access'), Response::HTTP_FORBIDDEN, '403 Forbidden');

        return new WorkingHourResource(WorkingHour::with(['workinghours'])->get());
    }
    ...
    public function show(WorkingHour $workingHour)
    {
        ...
        return new WorkingHourResource($workingHour->load(['workinghours']));
    }
